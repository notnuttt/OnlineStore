<?php
  ...
  $sql_query_food = 'SELECT * FROM dessert WHERE 1';
  $query_food = mysqli_query($conn, $sql_query_food);
  $query_food2 = $query_food;
  
?>
<!DOCTYPE html>

<html>
<title>N&N Café: Dessert</title>
<meta charset="UTF-8">
...
<nav class="w3-sidebar w3-bar-block w3-white w3-collapse w3-top" style="z-index:3;width:250px" id="mySidebar">
  ...
  <div class="w3-padding-64 w3-large w3-text-grey" style="font-weight:bold">
    ...
    <a href="index.php" class="w3-bar-item w3-button">Beverage</a>
...
<div id="newsletter" class="w3-modal">
  <div class="w3-modal-content w3-animate-zoom" style="padding:32px">
    <div class="w3-container w3-white w3-center">
      ...
      <form>
        <p><input class="w3-input w3-border" type="text" placeholder="Enter Username"></p>
        <p><input class="w3-input w3-border" type="password" placeholder="Enter Password"></p>
        <input type="submit" class="w3-button w3-padding-large w3-red w3-margin-bottom" onclick="document.getElementById('newsletter').style.display='none'" value="Login">
